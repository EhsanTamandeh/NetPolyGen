...
<div style="display: flex; gap: 10px;">
  <img src="https://drive.google.com/uc?id=1VsSVEJdFPbjaYq8jS64r8wmjbiDuxGdR" alt="Associated Gene-Gene Interaction Networks 1" width="500"/>
  <img src="https://drive.google.com/uc?id=1kxjGg6_y4VVem4oaWhqa7xM4PcUveQ_J" alt="Associated Gene-Gene Interaction Networks 2" width="500"/>
</div>

## Non-associated Gene-Gene Interaction Networks examples: 

<div style="display: flex; gap: 10px;">
  <img src="https://drive.google.com/uc?id=1K1oideyQ-gmqHapKv43mmIrRGQ55C_Jl" alt="Associated Gene-Gene Interaction Networks 1" width="500"/>
  <img src="https://drive.google.com/uc?id=1xNEEK4FMnt6pT3JvSdxyLlgbJdzgseNs" alt="Associated Gene-Gene Interaction Networks 2" width="500"/>
</div>
